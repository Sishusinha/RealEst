...
contract Escrow {
    address public nftAddress; //location of the asset on blockchain
    address public lender; // address of the lender(wanna do flash Loans)
    ...
    function approveSale(bool _appro, uint256 _nftID) public {
        approval[_nftID][msg.sender] = _appro;
    }

    function finalizeSale(uint256 _nftID) public {
        require(inspection[_nftID]);
